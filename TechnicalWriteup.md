...
Well, we don't actually desync, because the host periodically re-broadcasts the exact HP, Block, Barrier, and Seija's damage cap. In average gameplay, applying Vulnerable is not *that* common (you're not going to be applying it 10 separate times in a second), and people are not watching enemy health bars like a hawk. The host said the enemy has 350 HP, who cares about a small jump from 345 to 350? I bet most people wouldn't notice. Not even *I* have seen it happen in actual gameplay, unless I went out of my way to intentionally try to break it and kept an eye on the HP bar.
